...
class SkillAndInterestAdmin extends React.Component {
    ...
    onSelectRoleCategory = (index:any,value:any) => {
        // setSubCategory(value?.name);
        this.setState({role:value?.name})
    ...
    renderSubRoles = (rowData:any,highlighted:any) => {
        return (
            <DropDownRow
                highlighted={highlighted.name}
                text={rowData.name}
    ...
    renderContacts = (item:any) => {
        return(
            <CheckBox
                title={item?.title}
                checkBoxValue={item?.selected}
                onCheckboxValueChange={(value:any)=>{this.onPressContactItem(value,item)}}
            />
        )
    }
    onPressContactItem = (value:any,val:any) => {
        let tempIndex = this.state.contacts.indexOf(val);
        this.setState({contacts:this.state.contacts?.map((item,index)=>{
                if (tempIndex === index){
                    return{
                        ...item,
                        selected: value
    ...
    renderRoles = (item:any) => {
        return(
            <CheckBox
                title={item?.title}
                checkBoxValue={item?.selected}
                onCheckboxValueChange={(value:any)=>{this.onPressRoleItem(value,item)}}
            />
        )
    }
    onPressRoleItem = (value:any,val:any) => {
        let tempIndex = this.state.roles.indexOf(val);
        this.setState({roles:this.state.roles?.map((item,index)=>{
                if (tempIndex === index){
                    return{
                        ...item,
                        selected: value
                ...
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.contentContainer}>
                        <KeyboardAwareScrollView>
                            ...
                            {/*        <DropDown*/}
                            {/*            onSelect={(index: any, value: any) => {*/}
                            {/*                this.onSelectRoleCategory(index, value)*/}
                            {/*            }}*/}
                            {/*            defaultIndex={0}*/}
                            {/*            ref={(ref) => this.dropDownRef = ref}*/}
                            ...
                            {/*            // options={['one',"two","three"]}*/}
                            {/*            renderRow={(data: any, index: any, highlighted: any) => this.renderSubRoles(data, highlighted)}*/}
                            {/*        />*/}
                            {/*    </View>*/}
                            {/*</View>*/}
                            ...
                            <View style={{
                                ...
                                <Text
                                    style={[styles.textStyles, {fontWeight: "normal"}]}>{"Role: (one or more) "}</Text>
                                <TouchableOpacity onPress={()=>{this.setState({showRole:!this.state.showRole})}}>
                                    <Image source={images.arrow_down} style={[styles.arrowStyles,{transform: [{rotate: this.state.showRole ? "180deg" :"0deg"}]}]}/>
                                </TouchableOpacity>
                            </View>
                            {
                                this?.state?.showRole &&
                                <View style={{
                                    ...
                                    <FlatList data={this.state.roles} renderItem={({item}) => this.renderRoles(item)}/>
                                </View>
                            }
                            ...
                            <View style={{
                                ...
                                <Text
                                    style={[styles.textStyles, {fontWeight: "normal"}]}>{"Contact Method: (one or more) "}</Text>
                                <TouchableOpacity onPress={()=>{this.setState({showContact:!this.state.showContact})}}>
                                <Image source={images.arrow_down} style={[styles.arrowStyles,{transform: [{rotate: this.state.showContact ? "180deg" :"0deg"}]}]}/>
                                </TouchableOpacity>
                            </View>
                            {
                                ...
                                <View style={{
                                    ...
                                    <FlatList data={this.state.contacts} renderItem={({item}) => this.renderContacts(item)}/>
                                </View>
                            }
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity onPress={()=>{this.setState({showAvailability:!this.state.showAvailability})}}>
                                <Image source={images.arrow_down} style={[styles.arrowStyles,{transform: [{rotate: this.state.showAvailability ? "180deg" :"0deg"}]}]}/>
                                </TouchableOpacity>
                            </View>
                            {
                            ...
                            <View style={{height: RF(60),marginTop:RF(20)}}>
                                <View style={{
                                    height: RF(40),
                                    flexDirection: 'row',
                                    alignItems: 'center',
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        <Text style={[styles.textStyles, {fontSize: RF(9), fontWeight: "700", marginTop: RF(5)}]}>
...
export default SkillAndInterestAdmin;
